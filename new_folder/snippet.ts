...
const resultOne = snippet('TypeScript is programing language that is a strict syntactical superset of JavaScript and adds optional static typing to the language.', 40)
console.log(resultOne)

/* // missing seccond parameter 
